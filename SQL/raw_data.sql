create table if not exists raw_data ( id varchar(100),actor_name varchar(100),movie_name varchar(100), dob varchar(30),rel_date varchar(30));

insert into raw_data SELECT '1.','Jack Nicholson' AS Actor ,'Actor, The Shining' Movie,'22 April 1937' AS DOB,'15 Feb 2011' Rel_Date ;
insert into raw_data SELECT '2.','Ralph Fiennes','Actor, Harry Potter and the Deathly Hallows: Part 2','22 December 1962','14 Feb 2011' ;
insert into raw_data SELECT '3.','Daniel Day-Lewis','Actor, There Will Be Blood','29 April 1957','15 Feb 2011' ;
insert into raw_data SELECT '4.','Robert De Niro','Actor, Goodfellas','17 August 1943','15 Feb 2011' ;
insert into raw_data SELECT '5.','Al Pacino','Actor, The Godfather','25 April 1940','15 Feb 2011' ;
insert into raw_data SELECT '6.','Dustin Hoffman','Actor, Kramer vs. Kramer','8 August 1937','15 Feb 2011' ;
insert into raw_data SELECT '7.','Tom Hanks','Actor, The Da Vinci Code','9 July 1956','15 Feb 2011' ;
...
insert into raw_data SELECT '14.','Jeff Bridges','Actor, The Big Lebowski','4 December 1949','10 Oct 2010' ;
insert into raw_data SELECT '15.','Tim Robbins','Actor, The Shawshank Redemption','16 October 1958','10 Oct 2010' ;
insert into raw_data SELECT '16.','Henry Fonda','Actor, 12 Angry Men','16 May 1905','10 Oct 2010' ;
insert into raw_data SELECT '17.','William Hurt','Actor, Into the Wild','20 March 1950','15 Feb 2011' ;
...
insert into raw_data SELECT '24.','Tommy Lee Jones','Actor, No Country for Old Men','15 September 1946','11 Oct 2010' ;
insert into raw_data SELECT '25.','Kevin Spacey','Actor, American Beauty','26 July 1959','11 Oct 2010' ;
insert into raw_data SELECT '26.','Nicolas Cage' Name,'Actor, Leaving Las Vegas','7 January 1964' DOB ,'15 Feb 2011' ;
insert into raw_data SELECT '27.','Kevin Kline','Actor, A Fish Called Wanda','24 October 1947','15 Feb 2011' ;
...
insert into raw_data SELECT '34.','Steve McQueen','Actor, The Great Escape','24 March 1930','11 Oct 2010' ;
insert into raw_data SELECT '35.','Tom Cruise','Actor, Top Gun','3 July 1962','14 Feb 2011' ;
insert into raw_data SELECT '36.','Heath Ledger' name ,'Actor, The Dark Knight','4 April 1979' dob,'11 Oct 2010' ;
insert into raw_data SELECT '37.','Philip Seymour Hoffman','Actor, Capote','23 July 1967','11 Oct 2010' ;
...
insert into raw_data SELECT '44.','Edward Norton','Actor, Fight Club','18 August 1969','16 Feb 2011' ;
insert into raw_data SELECT '45.','Sean Connery','Actor, Dr. No','25 August 1930','16 Feb 2011' ;
insert into raw_data SELECT '46.','Yves Montand','Actor, Le salaire de la peur','13 October 1921','14 Feb 2011' ;
insert into raw_data SELECT '47.','Richard Gere','Actor, Pretty Woman','31 August 1949','13 Feb 2011' ;
...
insert into raw_data SELECT '54.','Woody Harrelson','Actor, No Country for Old Men','23 July 1961','10 Oct 2010' ;
insert into raw_data SELECT '55.','John Hurt','Actor, V for Vendetta','22 January 1940','15 Feb 2011' ;
insert into raw_data SELECT '56.','Sean Penn','Actor, Mystic River','17 August 1960','13 Feb 2011' ;
insert into raw_data SELECT '57.','Christopher Walken','Actor, Catch Me If You Can','31 March 1943','16 Feb 2011' ;
...
insert into raw_data SELECT '64.','James Coburn','Actor, Monsters, Inc.','31 August 1928','19 Feb 2011' ;
insert into raw_data SELECT '65.','Liam Neeson','Actor, Schindlers List','7 June 1952','20 Oct 2010' ;
insert into raw_data SELECT '66.','Will Smith','Actor, Men in Black','25 September 1968','13 Feb 2011' ;
insert into raw_data SELECT '67.','Robin Williams','Actor, Good Will Hunting','21 July 1951','14 Feb 2011' ;
...
insert into raw_data SELECT '74.','Chris Cooper','Actor, American Beauty','9 July 1951','14 Feb 2011' ;
insert into raw_data SELECT '75.','Gerard Depardieu','Actor, Life of Pi','27 December 1948','10 Oct 2010' ;
insert into raw_data SELECT '76.','Justin Theroux','Actor, American Psycho','10 August 1971','28 Oct 2011' ;
insert into raw_data SELECT '77.','Nick Nolte' NAME ,'Actor, The Thin Red Line','8 February 1941' dob,'15 Feb 2011' ;
...
insert into raw_data SELECT '84.','John Goodman','Actor, Monsters, Inc.','20 June 1952','11 Oct 2010' ;
insert into raw_data SELECT '85.','Arnold Schwarzenegger','Actor, Terminator','30 July 1947','16 Feb 2011' ;
insert into raw_data SELECT '86.','Adrien Brody','Actor, The Pianist','14 April 1973','10 Oct 2010' ;
insert into raw_data SELECT '87.','Michael Keaton','Actor, Birdman or (The Unexpected Virtue of Ignorance)','5 September 1951','13 Feb 2011' ;
...
insert into raw_data SELECT '94.','Jürgen Prochnow','Actor, Das Boot','10 June 1941','10 Oct 2010' ;
insert into raw_data SELECT '95.','Alec Baldwin','Actor, Beetlejuice','3 April 1958','13 Feb 2011' ;
